            ...
            <div className="contain-about">
                <div className="contain">
                    <div className="contain-p">
                        <p><span className="dash">-</span> I am a passionate computer science student with a deep love for problem-solving and a strong interest in front-end development.</p>
