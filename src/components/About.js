                ...
                <div className="contain">
                    <div className="contain-p">
                        <p><span className="dash">-</span> I am a passionate girl with a deep love for problem-solving and a strong interest in front-end development.</p>
                            ...
                            <p><span className="dash">-</span> With an insatiable curiosity and a commitment to excellence, I am dedicated to furthering my knowledge, embracing new technologies, and making a meaningful impact in the world of web development. My freelance work includes various projects, such as developing an accounting system and a dashboard. I'm excited to continue this incredible journey and see where it takes me..</p>
                    </div>
