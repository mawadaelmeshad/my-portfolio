            ...
            <div className="contain-about">
                <div className="contain">
                    <div className="contain-p">
                        <p><span className="dash">-</span> I am a passionate junior computer science student with a deep love for problem-solving and a strong interest in front-end development.</p>
                            <p><span className="dash">-</span> My journey in the field of technology has been a continuous exploration of learning and gaining valuable experiences. I thrive on the challenges of creating intuitive user interfaces and solving real-world problems through code.</p>  
